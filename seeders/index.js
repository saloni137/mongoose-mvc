...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'OA4li4LklZXMnC_',
      'isDeleted':false,
      'username':'Lizeth_Tremblay99',
      'email':'Cierra.Connelly@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Lizeth_Tremblay99' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'YedABH_EQWhcc37',
      'isDeleted':false,
      'username':'Frankie37',
      'email':'Cleta1@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Frankie37' }, userToBeInserted,  { upsert: true });
